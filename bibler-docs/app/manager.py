...
class ReferenceManager(object):
    ...
    The reference manager holds the list of all the :class:`entries<app.entry.Entry>`.
    """
    def __init__(self):
    ...
    def add(self, entryBibTeX, entryType=None):
        """
        @see: :class:`app.user_interface.BiBlerApp.addEntry`.           
        """
        if entryBibTeX == None:
            if entryType == None:
    ...
    def update(self, entryId, entryBibTeX):
        """
        @see: :class:`app.user_interface.BiBlerApp.updateEntry`.
        """
    ...
    def updateEntryField(self, entryId, fieldName, fieldValue):
        """
        @see: :class:`app.user_interface.BiBlerApp.updateEntryField`.
        """
        entry = self.getEntry(entryId)
        if entry == None:
            return False
    ...
    def delete(self, entryId):
        """
        @see: :class:`app.user_interface.BiBlerApp.deleteEntry`.
        """
        entry = self.getEntry(entryId)
        if entry == None:
            return False
    ...
    def duplicate(self, entryId):
        """
        @see: :class:`app.user_interface.BiBlerApp.duplicateEntry`.
        """
        entry = self.getEntry(entryId)
        if entry == None:
            return None
    ...
    def search(self, query):
        """
        @see: :class:`app.user_interface.BiBlerApp.search`.
        """
        try:
    ...
    def sort(self, field, reverse=False):
        """
        @see: :class:`app.user_interface.BiBlerApp.sort`.
        """
    ...
    def generateAllKeys(self):
        """
        @see: :class:`app.user_interface.BiBlerApp.generateAllKeys`.
        """
        try:
    ...
    def getEntry(self, entryId):
        ...
        :rtype: :class:`app.entry.Entry`
        :return: The entry, :class:`None` if not found.
        """
    ...
    def iterEntries(self):
        ...
        :rtype: ``generator`` of :class:`app.entry.Entry`
    ...
    def getEntryCount(self):
        """
        @see: :class:`app.user_interface.BiBlerApp.getEntryCount`.
        """
    ...
    def getSearchResultCount(self):
        """
        @see: :class:`app.user_interface.BiBlerApp.getSearchResultCount`.
        """
        return len(self.searchResult)
    ...
    def __setKey(self, entry):
        ...
        :type entry: :class:`app.entry.Entry`
        :param entry: The entry.
        :raises: Exception: If the first author of the entry published more than 27 on the entry's publication year.
        """

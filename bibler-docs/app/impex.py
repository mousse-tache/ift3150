...
class ImpEx(object):
    ...
    Every Impex has a :class:`path` to the database file and a :class:`database` file handler.
    """
    ...
    def openDB(self, mode):
        ...
        :type mode: :class:`str`
        :param mode: Any mode support by python `open<https://docs.python.org/3.5/library/functions.html#open>`.
        """
        try:
...
class Exporter(ImpEx):
    """
    Export a list of :class:`Entries<app.entry.Entry>` to a specified format.
    """
    def __init__(self, path, entries):
        """
        :type path: :class:`str`
        :param path: The path to a file.
        :type entries: list of :class:`app.entry.Entry`
    ...
    def export(self):
        ...
        :raises: Exception: If an error occurred during the export process.
        """
        total = 0
        try:
            self.openDB('w')
...
class BibTeXExporter(Exporter):
    """
    Export a list of :class:`Entries<app.entry.Entry>` to a BibTeX file.
    """
    def __init__(self, path, entries):
        """
        :type path: :class:`str`
...
class CSVExporter(Exporter):
    """
    Export a list of :class:`Entries<app.entry.Entry>` to a CSV (tabs) file.
    """
    def __init__(self, path, entries):
        """
        :type path: :class:`str`
...
class HTMLExporter(Exporter):
    """
    Export a list of :class:`Entries<app.entry.Entry>` to an HTML file in the default style.
    """
    def __init__(self, path, entries):
        """
        :type path: :class:`str`
...
class MySQLExporter(Exporter):
    """
    Export a list of :class:`Entries<app.entry.Entry>` to a MySQL database script.
    """
    def __init__(self, path, entries):
        """
        :type path: :class:`str`
...
class StringExporter(Exporter):
    """
    Export a list of :class:`Entries<app.entry.Entry>` to a specified format in a string.
    """
    def __init__(self, path, entries):
        """
        :type path: :class:`str`
...
class CSVStringExporter(StringExporter):
    """
    Export a list of :class:`Entries<app.entry.Entry>` to a CSV formatted String.
    """
    def __init__(self, path, entries):
        """
        :type path: :class:`str`
...
class HTMLStringExporter(StringExporter):
    """
    Export a list of :class:`Entries<app.entry.Entry>` to an HTML file in the default style as a String.
    """
    def __init__(self, path, entries):
        """
        :type path: :class:`str`
...
class MySQLStringExporter(StringExporter):
    """
    Export a list of :class:`Entries<app.entry.Entry>` to a MySQL database script as String.
    """
    def __init__(self, path, entries):
        """
        :type path: :class:`str`
...
class Importer(ImpEx):
    """
    Import entries :class:`Entries<app.entry.Entry>` from a specified format.
    """
    def __init__(self, path, manager):
        """
        :type path: :class:`str`
        :param path: The path to a file.
        :type manager: list of :class:`app.manager.ReferenceManager`
...
class BibTeXImporter(Importer):
    """
    Import entries :class:`Entries<app.entry.Entry>` from a BibTeX file.
    """
    def __init__(self, path, manager):
        """
        :type path: :class:`str`
...
class EndNoteImporter(Importer):
    """
    Import entries :class:`Entries<app.entry.Entry>` from a BibTeX file exported from EndNote using the BiBler exporter.
    """
    def __init__(self, path, manager):
        """
        :type path: :class:`str`
...
class CSVImporter(Importer):
    """
    Import entries :class:`Entries<app.entry.Entry>` from a CSV (tabs) file. The first row must consist of the field names for each column.
    This operation is meant to be the inverse for the :class:`CSVExporter`.
    """
    def __init__(self, path, manager):
        """
        :type path: :class:`str`

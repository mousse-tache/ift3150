...
DIRECTORY="/var/www/html/ift3150/bibler-docs/gui/"
...
if [ ! $DIRECTORY ]; then
    echo "Usage: ./migrate_docstrings.sh </var/www/html/ift3150/bibler-docs/> <suffix_path>"
    exit 1
fi
...
NEW_VALUES[6]='``\1``'
NEW_VALUES[7]=':\1'
NEW_VALUES[8]=':class:`\1`'
NEW_VALUES[9]=':note:'
NEW_VALUES[10]=':raises:'
NEW_VALUES[11]='`\1`'

...
class ResourceManager(object, metaclass=utils.Singleton):
    ...
    def getAboutHTML(self):
        """
        Get the path to the web page for the :class:`AboutBox<gui.gui.HTMLDialog>`.
        """
        return self.__getPath(self.aboutHTMLPath)
    
    def getUserManualHTML(self):
        """
        Get the path to the web page for the :class:`UserManualWindow<gui.gui.HTMLWindow>`.
        """
    ...
    def __getPath(self, path):
        ...
        :raises: Exception: if the resource file was not found.
        """

...
It should be used as an API that a :class:`statechart<gui.statechart.BiBler_Statechart>`, a :class:`GUI<gui.BiBlerGUI>` and an :class:`application<app_interface.IApplication>` can invoke.
'''
...
class ControllerLogicException(Exception):
    """
    Exception that can be raised by the :class:`Controller`.
    """
...
class Controller(object):
    ...
    *Clicked, preferencesChanged, textChangedInEditor, entryDeselected, entrySelected, exportFileSelected, importFileSelected, openFileSelected, saveFileSelected
    ...
    def bindSC(self, statechart):
        ...
        :type statechart: :class:`statechart`
    ...
    def bindApp(self, application):
        ...
        :type application: :class:`IApplication`
    ...
    def start(self):
        ...
        Sends a :class:`start` event to the statechart. 
        """
        self.GUI.start()
        self.APP.start()
        self.SC.initModel()
    ...
    def exit(self):
        ...
        Sends an :class:`exit` event to the statechart. 
        """
        self.APP.exit()
        self.GUI.exit()
    ...
    def __sendEvent(self, e):
        """
        Send event :class:`e` to the statechart.
        :type e: :class:`str`
        :param e: The event.
        """
        try:
    ...
    def __sendError(self, ex):
        ...
        Send an An :class:`error` event to the statechart.
    ...
    def __sendAppOperationResult(self, condition=lambda: True, ex=Exception('An error has occurred.')):
        """
        Send a :class:`success` event to the statechart if an operation it called was successful.
        Otherwise send a :class:`fail` event.
        :type condition: :class:`function`
        :param condition: A function that returns a :class:`bool`.
        :rtype: :class:`bool`
        :return: :class:`True` if :class:`condition()==True`, :class:`False` otherwise.
        """
        if condition():
    ...
    def exitClicked(self):
        ...
        Send an :class:`exitClicked` event to the statechart.
        """
    ...
    def forceExitClicked(self):
        ...
        Send a :class:`forceExitClicked` event to the statechart.
        """
    ...
    def openClicked(self):
        ...
        Send an :class:`openClicked` event to the statechart.
        """
    ...
    def openFileSelected(self, path, importFormat):
        ...
        Send a :class:`openFileSelected` event to the statechart.
        :type path: :class:`str`
        :param path: The path to a file. It is stored in the controller data.
        :type importFormat: :class:`settings.ImportFormat`
    ...
    def saveClicked(self, exportFormat):
        ...
        Send a :class:`saveClicked` event to the statechart.
        :type exportFormat: :class:`settings.ExportFormat`
    ...
    def saveAsClicked(self):
        ...
        Send a :class:`saveAsClicked` event to the statechart.
        """
    ...
    def saveFileSelected(self, path, exportFormat):
        ...
        Send a :class:`saveFileSelected` event to the statechart.
        :type path: :class:`str`
        :param path: The path to a file. It is stored in the controller data.
        :type exportFormat: :class:`settings.ExportFormat`
    ...
    def importClicked(self):
        ...
        Send a :class:`importClicked` event to the statechart.
        """
    ...
    def importFileSelected(self, path, importFormat):
        ...
        Send a :class:`importFileSelected` event to the statechart.
        :type path: :class:`str`
        :param path: The path to a file. It is stored in the controller data.
        :type importFormat: :class:`settings.ImportFormat`
        :param importFormat: The format of the file. It is stored in the controller data.
    ...
    def exportClicked(self):
        ...
        Send a :class:`exportClicked` event to the statechart.
        """
    ...
    def exportFileSelected(self, path, exportFormat):
        ...
        Send a :class:`exportFileSelected` event to the statechart.
        :type path: :class:`str`
        :param path: The path to a file. It is stored in the controller data.
        :type exportFormat: :class:`settings.ExportFormat`
        :param exportFormat: The format of the file. It is stored in the controller data.
    ...
    def addClicked(self):
        ...
        Send a :class:`addClicked` event to the statechart.
        """
    ...
    def entryTypeSelected(self, entry):
        ...
        Send a :class:`entryTypeSelected` event to the statechart.
        """
    ...
    def entrySelected(self, entryId):
        ...
        Send a :class:`entrySelected` event to the statechart.
    ...
    def entryDeselected(self, flag):
        ...
        Send a :class:`entryDeselected` event to the statechart.
        """ 
    ...
    def allEntryDeselected(self):
        ...
        Send a :class:`allEntryDeselected` event to the statechart.
        """ 
        self.data.currentEntryId = None
    ...
    def entryDoubleClicked(self, entryId):
        ...
        Send a :class:`entryDoubleClicked` event to the statechart.
        :type entryId: :class:`int`
        :param entryId: The I{id} of the entry. It is stored in the controller data.
        """
        self.data.currentEntryId = entryId
    ...
    def updateButtonClicked(self, entryBibTeX):
        ...
        Send a :class:`updateButtonClicked` event to the statechart.
    ...
    def duplicateClicked(self):
        ...
        Send a :class:`duplicateClicked` event to the statechart.
        """
    ...
    def deleteClicked(self):
        ...
        Send a :class:`deleteClicked` event to the statechart.
        """
    ...
    def genKeysClicked(self):
        ...
        Send a :class:`genKeysClicked` event to the statechart.
        """
    ...
    def validateAllClicked(self):
        ...
        Send a :class:`validateAllClicked` event to the statechart.
        """
    ...
    def textChangedInEditor(self, text):
        ...
        Send a :class:`textChangedInEditor` event to the statechart. It is stored in the controller data.
        :type text: :class:`str`
    ...
    def textChangedInFieldEditor(self, text, field):
        ...
        Send a :class:`textChangedInFieldEditor` event to the statechart. It is stored in the controller data.
        :type text: :class:`str`
    ...
    def undoClicked(self):
        ...
        Send a :class:`undoClicked` event to the statechart.
        """
    ...
    def searchClicked(self):
        ...
        Send a :class:`searchClicked` event to the statechart.
        """
    ...
    def filterClicked(self, query):
        ...
        Send a :class:`filterClicked` event to the statechart.
    ...
    def clearFilterClicked(self):
        ...
        Send a :class:`clearFilterClicked` event to the statechart.
        """
    ...
    def preferencesClicked(self):
        ...
        Send a :class:`preferencesClicked` event to the statechart.
        """
    ...
    def preferencesChanged(self):
        ...
        Send a :class:`preferencesChanged` event to the statechart.
        """
    ...
    def aboutClicked(self):
        ...
        Send a :class:`aboutClicked` event to the statechart.
        """
    ...
    def manualClicked(self):
        ...
        Send a :class:`manualClicked` event to the statechart.
        """
    ...
    def cancelClicked(self):
        ...
        Send a :class:`cancelClicked` event to the statechart.
        """
    ...
    def colIdClicked(self):
        ...
        Send a :class:`colClicked` event to the statechart.
    ...
    def __sendColKeyClicked(self, col):
        """
        Internal method that actually sends a :class:`colClicked` event to the statechart.
    ...
    def openFile(self):
        ...
        :class:`success` or :class:`fail` event is sent to the statechart if operation is successful or not.
        
        An :class:`error` event is sent to the statechart if no file was selected, the import format is undefined,
        :class:`IApplication.importFile<gui.app_interface.IApplication.importFile>` raised an exception,
        or :class:`IApplication.getAllEntries<gui.app_interface.IApplication.getAllEntries>` raised an exception.
        """        
    ...
    def saveFile(self):
        ...
        An :class:`error` event is sent to the statechart if no file was selected, the export format is undefined,
        or :class:`IApplication.exportFile<gui.app_interface.IApplication.exportFile>` raised an exception.
        """
        if self.data.bibtexFilepath is None:
            self.__sendError(ControllerLogicException('No file was selected.'))
    ...
    def addEntry(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`IApplication.addEntry<gui.app_interface.IApplication.addEntry>` raised an exception,
        or :class:`IApplication.getEntry<gui.app_interface.IApplication.getEntry>` raised an exception,
        or :class:`IApplication.getAllEntries<gui.app_interface.IApplication.getAllEntries>` raised an exception.
        """
    ...
    def duplicateEntry(self):
        ...
        An :class:`error` event is sent to the statechart if no entry was selected
        :class:`IApplication.duplicateEntry<gui.app_interface.IApplication.duplicateEntry>` raised an exception,
        :class:`IApplication.getEntry<gui.app_interface.IApplication.getEntry>` raised an exception,
        or :class:`IApplication.getAllEntries<gui.app_interface.IApplication.getAllEntries>` raised an exception.
        """
    ...
    def updateEntry(self):
        ...
        An :class:`error` event is sent to the statechart if no entry was selected, the entry was not converted to BibTeX format,
        :class:`IApplication.getEntry<gui.app_interface.IApplication.getEntry>` raised an exception,
        or :class:`IApplication.updateEntry<gui.app_interface.IApplication.updateEntry>` raised an exception.
        """
        if self.data.currentEntryId is None:
            self.__sendError(ControllerLogicException('No entry was selected.'))
    ...
    def deleteEntry(self):
        ...
        An :class:`error` event is sent to the statechart if no entry was selected
        :class:`IApplication.deleteEntry<gui.app_interface.IApplication.deleteEntry>` raised an exception,
        or :class:`IApplication.getAllEntries<gui.app_interface.IApplication.getAllEntries>` raised an exception.
        """
        if self.data.currentEntryId is None:
            self.__sendError(ControllerLogicException('No entry was selected.'))
    ...
    def previewEntry(self):
        ...
        An :class:`error` event is sent to the statechart if no entry was selected
        or :class:`IApplication.previewEntry<gui.app_interface.IApplication.previewEntry>` raised an exception.
        """
        if self.data.currentEntryId is None:
            self.__sendError(ControllerLogicException('No entry was selected.'))
        else:
    ...
    def generateAllKeys(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`IApplication.generateAllKeys<gui.app_interface.IApplication.generateAllKeys>` raised an exception.
        """
        try:
    ...
    def validateAll(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`IApplication.previewEntry<gui.app_interface.IApplication.validateAllEntries>` raised an exception.
        """
        try:
    ...
    def search(self):
        ...
        An :class:`error` event is sent to the statechart if no search query was provided
        or :class:`IApplication.search<gui.app_interface.IApplication.search>` raised an exception.
        """
    ...
    def sort(self):
        ...
        An :class:`error` event is sent to the statechart if no column was selected
        or :class:`IApplication.sort<gui.app_interface.IApplication.sort>` raised an exception.
        """
    ...
    def undo(self):
        ...
        An :class:`error` event is sent to the statechart if
        or :class:`IApplication.undo<gui.app_interface.IApplication.undo>` raised an exception.
        """
    ...
    def currentEntryHasPaper(self):
        ...
        :rtype: :class:`bool`
        :return: :class:`True` if there is a paper, :class:`False` otherwise.
        """
    ...
    def hasUndoableActionLeft(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`IApplication.hasUndoableActionLeft<gui.app_interface.IApplication.hasUndoableActionLeft>` raised an exception.
        :rtype: :class:`bool`
        :return: :class:`True` if there is an action to undo, :class:`False` otherwise.
        """
        try:
    ...
    def getBibTeX(self):
        ...
        An :class:`error` event is sent to the statechart if no entry was selected
        or :class:`IApplication.getBibTeX<gui.app_interface.IApplication.getBibTeX>` raised an exception.
        """
        if self.data.currentEntryId is None:
            self.__sendError(ControllerLogicException('No entry was selected.'))
        else:
    ...
    def getEntryDict(self):
        """
        Convert the selected entry to its :class:`EntryDict` format.
        
        :class:`success` or :class:`fail` event is sent to the statechart if operation is successful or not.
        
        An :class:`error` event is sent to the statechart if no entry was selected
        or :class:`IApplication.getBibTeX<gui.app_interface.IApplication.getEntryDict>` raised an exception.
        """
        if self.data.currentEntryId is None:
            self.__sendError(ControllerLogicException('No entry was selected.'))
        else:
    ...
    def getEntryRequiredFields(self):
        ...
        An :class:`error` event is sent to the statechart if no entry was selected
        or :class:`IApplication.getEntryRequiredFields<gui.app_interface.IApplication.getEntryRequiredFields>` raised an exception.
        """
        if self.data.currentEntryId is None:
            self.__sendError(ControllerLogicException('No entry was selected.'))
        else:
    ...
    def getEntryOptionalFields(self):
        ...
        An :class:`error` event is sent to the statechart if no entry was selected
        or :class:`IApplication.getEntryOptionalFields<gui.app_interface.IApplication.getEntryOptionalFields>` raised an exception.
        """
        if self.data.currentEntryId is None:
            self.__sendError(ControllerLogicException('No entry was selected.'))
        else:
    ...
    def getEntryAdditionalFields(self):
        ...
        An :class:`error` event is sent to the statechart if no entry was selected
        or :class:`IApplication.getEntryAdditionalFields<gui.app_interface.IApplication.getEntryAdditionalFields>` raised an exception.
        """
        if self.data.currentEntryId is None:
            self.__sendError(ControllerLogicException('No entry was selected.'))
        else:
    ...
    def getDisplayedEntryCount(self):
        ...
        An :class:`error` event is sent to the statechart if there is no entry list displayed.
        :rtype: :class:`int`
    ...
    def getAllEntries(self):
        """
        Load all entries in :class:`EntryDict<gui.app_interface.IApplication.EntryDict>` format.
        
        :class:`success` or :class:`fail` event is sent to the statechart if operation is successful or not.
        
        An :class:`error` event is sent to the statechart if no entry was loaded
        or :class:`IApplication.getAllEntries<gui.app_interface.IApplication.getAllEntries>` raised an exception.
        """
        try:
            self.data.entryList = self.APP.iterAllEntries()
    ...
    def isBibtexFileLoaded(self):
        ...
        :rtype: :class:`bool`
        :return: :class:`True` a BibTeX file is open, :class:`False` otherwise.
        """
    ...
    def isEntrySelected(self):
        ...
        An :class:`error` event is sent to the statechart if
        or :class:`BiBlerGUI.isEntrySelected<gui.BiBlerGUI.isEntrySelected>` raised an exception.
        :rtype: :class:`bool`
        :return: :class:`True` an entry is selected, :class:`False` otherwise.
        """
        try:
    ...
    def hasUnsavedModifications(self):
        ...
        An :class:`error` event is sent to the statechart if
        or :class:`BiBlerGUI.hasUnsavedModifications<gui.BiBlerGUI.hasUnsavedModifications>` raised an exception.
        """
        try:
    ...
    def setDirtyTitle(self):
        ...
        An :class:`error` event is sent to the statechart if
        or :class:`BiBlerGUI.setDirtyTitle<gui.BiBlerGUI.setDirtyTitle>` raised an exception.
        """
        try:
    ...
    def unsetDirtyTitle(self):
        ...
        An :class:`error` event is sent to the statechart if
        or :class:`BiBlerGUI.unsetDirtyTitle<gui.BiBlerGUI.unsetDirtyTitle>` raised an exception.
        """
        try:
    ...
    def displayEntries(self):
        ...
        An :class:`error` event is sent to the statechart if there is no entry list displayed
        or :class:`BiBlerGUI.displayEntries<gui.BiBlerGUI.displayEntries>` raised an exception.
        """
        if self.data.entryList is None:
            self.__sendError(ControllerLogicException('No entry list found.'))
        else:
    ...
    def addNewEntryRow(self):
        ...
        An :class:`error` event is sent to the statechart if the current entry was not converted into an :class:`EntryDict<gui.app_interface.EntryDict>`,
        or :class:`BiBlerGUI.addNewEntryRow<gui.BiBlerGUI.addNewEntryRow>` raised an exception.
        """
    ...
    def updateSelectedEntryRow(self):
        ...
        An :class:`error` event is sent to the statechart if the current entry was not converted into an :class:`EntryDict<gui.app_interface.EntryDict>`,
        or :class:`BiBlerGUI.updateSelectedEntryRow<gui.BiBlerGUI.updateSelectedEntryRow>` raised an exception.
        """
        if self.data.currentEntryDict is None:
            self.__sendError(ControllerLogicException('Entry must be converted to dictionary format.'))
        else:
    ...
    def removeEntryRow(self):
        ...
        An :class:`error` event is sent to the statechart if there is no entry was selected
        or :class:`BiBlerGUI.removeEntryRow<gui.BiBlerGUI.removeEntryRow>` raised an exception.
        """
        if self.data.currentEntryId is None:
    ...
    def selectCurrentEntryRow(self):
        ...
        An :class:`error` event is sent to the statechart if there is no entry was selected
        or :class:`BiBlerGUI.selectEntryRow<gui.BiBlerGUI.selectEntryRow>` raised an exception.
        """
        if self.data.currentEntryId is None:
            self.__sendError(ControllerLogicException('Entry not found.'))
        else:
    ...
    def unselectEntryRow(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.unselectEntryRow<gui.BiBlerGUI.unselectEntryRow>` raised an exception.
        """
        try:
    ...
    def clearList(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.clearList<gui.BiBlerGUI.clearList>` raised an exception.
        """
        try:
    ...
    def displayBibTexInEditor(self):
        ...
        An :class:`error` event is sent to the statechart if the entry was not converted to BibTeX format
        or :class:`BiBlerGUI.displayBibTexInEditor<gui.BiBlerGUI.displayBibTexInEditor>` raised an exception.
        """
    ...
    def clearEditor(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.clearEditor<gui.BiBlerGUI.clearEditor>` raised an exception.
        """
        try:
    ...
    def clearBibtexEditor(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.clearEditor<gui.BiBlerGUI.clearBibtexEditor>` raised an exception.
        """
        try:
    ...
    def previewEntryHTML(self):
        ...
        An :class:`error` event is sent to the statechart if the entry was not converted to HTML format
        or :class:`BiBlerGUI.previewEntry<gui.BiBlerGUI.previewEntry>` raised an exception.
        """
    ...
    def clearPreviewer(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.clearPreviewer<gui.BiBlerGUI.clearPreviewer>` raised an exception.
        """
        try:
    ...
    def openEntryPaper(self):
        ...
        An :class:`error` event is sent to the statechart if the entry has no paper
        or :class:`BiBlerGUI.openURL<gui.BiBlerGUI.openURL>` raised an exception.
        """
        try:
    ...
    def popupOpenDialog(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.popupOpenDialog<gui.BiBlerGUI.popupOpenDialog>` raised an exception.
        """
        try:
    ...
    def popupSaveDialog(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.popupSaveDialog<gui.BiBlerGUI.popupSaveDialog>` raised an exception.
        """
        try:
    ...
    def popupImportDialog(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.popupImportDialog<gui.BiBlerGUI.popupImportDialog>` raised an exception.
        """
        try:
    ...
    def popupExportDialog(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.popupExportDialog<gui.BiBlerGUI.popupExportDialog>` raised an exception.
        """
        try:
    ...
    def popupSearchDialog(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.popupSearchDialog<gui.BiBlerGUI.popupSearchDialog>` raised an exception.
        """
        try:
    ...
    def popupAddNewEntryDialog(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.popupAddNewEntryDialog<gui.BiBlerGUI.popupAddNewEntryDialog>` raised an exception.
        """
        try:
    ...
    def popupValidationResultMessage(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.popupOpenDialog<gui.BiBlerGUI.popupValidationResultMessage>` raised an exception.
        """
        try:
    ...
    def popupPreferencesDialog(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.popupPreferencesDialog<gui.BiBlerGUI.popupPreferencesDialog>` raised an exception.
        """
        try:
    ...
    def popupAboutDialog(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.popupAboutDialog<gui.BiBlerGUI.popupAboutDialog>` raised an exception.
        """
        try:
    ...
    def popupUserManualWindow(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.popupUserManualWindow<gui.BiBlerGUI.popupUserManualWindow>` raised an exception.
        """
        try:
    ...
    def popupConfirmExitDialog(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.popupConfirmExitDialog<gui.BiBlerGUI.popupConfirmExitDialog>` raised an exception.
        """
        try:
    ...
    def popupPendingChangesOnExitDialog(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.popupPendingChangesOnExitDialog<gui.BiBlerGUI.popupPendingChangesOnExitDialog>` raised an exception.
        """
        try:
    ...
    def popupErrorMessage(self, msg=None):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.popupErrorMessage<gui.BiBlerGUI.popupErrorMessage>` raised an exception.
        """
        if msg is None:
    ...
    def setValidationMsgInStatus(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.updateStatusBar<gui.BiBlerGUI.updateStatusBar>` raised an exception.
        """
    ...
    def clearStatusBar(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.clearStatusBar<gui.BiBlerGUI.clearStatusBar>` raised an exception.
        """
        try:
    ...
    def updateStatusTotal(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.updateStatusBarTotal<gui.BiBlerGUI.updateStatusBarTotal>` raised an exception.
        """
        try:
    ...
    def enableClearFilter(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.enableClearFilter<gui.BiBlerGUI.enableClearFilter>` raised an exception.
        """
        try:
    ...
    def disableClearFilter(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.disableClearFilter<gui.BiBlerGUI.disableClearFilter>` raised an exception.
        """
        try:
    ...
    def enableDelete(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.enableDelete<gui.BiBlerGUI.enableDelete>` raised an exception.
        """
        try:
    ...
    def disableDelete(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.disableDelete<gui.BiBlerGUI.disableDelete>` raised an exception.
        """
        try:
    ...
    def enableDuplicate(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.enableDuplicate<gui.BiBlerGUI.enableDuplicate>` raised an exception.
        """
        try:
    ...
    def disableDuplicate(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.disableDuplicate<gui.BiBlerGUI.disableDuplicate>` raised an exception.
        """
        try:
    ...
    def enableUndo(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.enableUndo<gui.BiBlerGUI.enableUndo>` raised an exception.
        """
        try:
    ...
    def disableUndo(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.disableUndo<gui.BiBlerGUI.disableUndo>` raised an exception.
        """
        try:
    ...
    def enableUpdateButton(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.enableUpdateButton<gui.BiBlerGUI.enableUpdateButton>` raised an exception.
        """
        try:
    ...
    def disableUpdateButton(self):
        ...
        An :class:`error` event is sent to the statechart if
        :class:`BiBlerGUI.disableUpdateButton<gui.BiBlerGUI.disableUpdateButton>` raised an exception.
        """
        try:

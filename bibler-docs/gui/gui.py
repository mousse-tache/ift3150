...
class EntryWidget(object):
    ...
    def __init__(self, rows, cols, behavior=None):
        """
        :type rows: :class:`int`
        :param rows: The number of rows of the :class:`wx.FlexGridSizer` of the widget.
        :type cols: :class:`int`
        :param cols: The number of columns of the :class:`wx.FlexGridSizer` of the widget.
        :type behavior: :class:`controller.Controller`
    ...
    def getSizer(self):
        """
        Get the sizer of the :class:`EntryEditor`.
        
        :rtype: :class:`wx.FlexGridSizer`
        :return: The sizer.
        """
        return self.sizer
    ...
    def getBehavior(self):
        """
        :rtype behavior: :class:`controller.Controller`
...
class EntryList(wx.ListCtrl, wxLC.ListCtrlAutoWidthMixin):
    """
    The list of entries.    
    It contains the 7 columns from :class:`gui.app_interface.EntryDict`: id, Paper, Type, Author, Title, Year, Key.
    @group Events: __on*
    ...
    def GetListCtrl(self):
        """
        Required by :class:`wx.lib.mixins.listctrl.ListCtrlAutoWidthMixin`.
        """
        return self
    ...
    def isEntrySelected(self):
        ...
        :rtype: :class:`bool`
        :return: :class:`True` if a row is selected. :class:`False` otherwise.
        """
    ...
    def selectEntryRow(self, entryId):
        ...
        :raises: Exception: If no entry was found.
        """
    ...
    def displayEntries(self, entryList):
        ...
        :type entryList: :class:`list` of :class:`EntryDict`
    ...
    def addEntryRow(self, entryDict):
        ...
        :type entryDict: :class:`EntryDict`
    ...
    def updateSelectedEntryRow(self, entryDict):
        ...
        :type entryDict: :class:`EntryDict`
        :param entryDict: The dictionary representation of an entry.
        :raises: Exception: If no row was selected.
        """
    ...
    def showPDFIcon(self, row, data):
        """
        Display a PDF icon in the :class:`paper` column if :class:`data != ''`.
        :type row: :class:`int`
        :param row: The index of a row.
        :type data: :class:`str`
    ...
    def colorRow(self, row, data):
        """
        Color the row in red if :class:`data` is :class:`False`.
        :type row: :class:`int`
        :param row: The index of a row.
        :type data: :class:`str`
        :param data: The uri of the paper.
    ...
    def __entryDictToRowTuple(self, entryDict):
        """
        Converts an :class:`EntryDict` into a :class:`tuple`.
        The order of the data is the same as in :class:`EntryList`.
        In the case of multiple authors, the I{et al.} notation is used.
        :type entryDict: :class:`EntryDict`
        :param entryDict: The dictionary representation of an entry.
        :rtype: :class:`tuple`
        :return: The tuple representation of the :class:`entryDict`.
        """
...
class EditorTab(wx.Panel):
    """
    A tab in the :class:`EntryEditor`.
    """
    WARNING_COLOR = wx.Colour(255, 246, 232)
    ERROR_COLOR = wx.Colour(255, 127, 127)
    SUCCESS_COLOR = wx.Colour(255, 255, 255)
...
class EditorFieldsTab(EditorTab):
    """
    Abstract class for tabs with editable fields in the :class:`EntryEditor`.
    """
    def __init__(self, parent, behavior):
        """
        :type parent: :class:`EditorTab`
        :param parent: The parent window. Must be not ``None``.
        :type behavior: :class:`controller.Controller`
        :param behavior: The statechart controller that defines the behavior of this widget.
        """
    ...
    def setFields(self, data):
        """
        Replace text in fields tabs with names and values from :class:`data`.
    ...
    def onTextChangedInFieldEditor(self, e):
        ...
        :type evt: :class:`wx.CommandEvent`
        :param evt: :class:`wx_TxtCtrl` triggered event
...
class RequiredFields(EditorFieldsTab):
    ...
    def __init__(self, parent, behavior):
        """
        @see: :class:`gui.EditorFieldsTab.__init__`.
        """
    ...
    def setFields(self, data):
        """
        @see: :class:`gui.EditorFieldsTab.setFields`.
        """
        if len(self.ItemsList) == 0:
            for field in data:
                self.fieldsEditorLabel = wx.StaticText(self, wx.NewId(), label=field.getName())                
            ...
            newItems = []
            for field in data:
                newItems.append({'label':field.getName(), 'text':field.getValue()})
...
class OptionalFileds(EditorFieldsTab):
    ...
    def setFields(self, data):
        ...
        if len(self.ItemsList) == 0:
            for field in data:
                self.fieldsEditorLabel = wx.StaticText(self, wx.NewId(), style=wx.ALIGN_RIGHT, label=field.getName())
                self.fieldsEditorLabel.SetForegroundColour(self.LABEL_COLOR)
                self.fieldsEditor = wx.TextCtrl(self, wx.NewId(), 
...
class EntryEditor(EntryWidget):
    ...
    def setBibtex(self, data):
        """
        Replace text in the BibTeX editor with :class:`data`.
        :type data: :class:`str`
...
class ActionCancelDialog(wx.Dialog):
    ...
    The :class:`performAction` method can be overridden to customize the action of the action button.
    @group Events: __on*
    @sort: __*, g*, p*, s*
    """
    ...
    def ShowModal(self):
        """
        :raises: Exception: If :class:`setSizer` was not called before.
        """
...
class PreferencesDialog(ActionCancelDialog):
    ...
    def performAction(self, e):
        ...
        Stores the preferences in :class:`prefs`
        :type e: :class:`wx.CommandEvent`
        """
...
class BiBlerGUI(wx.Frame):
    ...
    def hasUnsavedModifications(self):
        """
        Check of there is a :class:`*` at the end of the title in the title bar. 
        """
        return self.GetTitle()[-1] == '*'
    
    def setDirtyTitle(self):
        """
        Place a :class:`*` at the end of the title in the title bar. 
        """
        title = self.GetTitle()
        if title[-1] != '*':
            self.SetTitle(title + '*')
    ...
    def unsetDirtyTitle(self):
        """
        Remove the :class:`*` from the title in the title bar. 
        """
        title = self.GetTitle()
        if title[-1] == '*':
    ...
    def updateSelectedEntryRow(self, entryDict):
        """
        @see: :class:`EntryList.updateSelectedEntryRow`.
        """
    ...
    def addNewEntryRow(self, entryDict):
        """
        @see: :class:`EntryList.addEntryRow`.
        """
        return self.entryList.addEntryRow(entryDict)
    
    def selectEntryRow(self, entryId):
        """
        @see: :class:`EntryList.selectEntryRow`.
        """
        return self.entryList.selectEntryRow(entryId)
    
    def isEntrySelected(self):
        """
        @see: :class:`EntryList.isEntrySelected`.
        """
        return self.entryList.isEntrySelected()
    
    def removeEntryRow(self, entryId):
        """
        @see: :class:`EntryList.removeEntryRow`.
        """
        return self.entryList.removeEntryRow(entryId)
    
    def unselectEntryRow(self):
        """
        @see: :class:`EntryList.unselectEntryRow`
        """
    ...
    def popupAboutDialog(self):
        """
        Open the about box.
        @see: :class:`HTMLDialog`.
        The content of this dialog is contained in :class:`utils.resourcemgr.ResourceManager.getAboutHTML`
        """
    ...
    def popupUserManualWindow(self):
        ...
        The content of this window is contained in :class:`utils.resourcemgr.ResourceManager.getUserManualHTML`.
        @see: :class:`HTMLWindow`.
        """

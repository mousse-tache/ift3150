...
INSERT INTO Paper (bibtexKey,title,doi,bibtex,preview) VALUES (N'Adams1978', N'H2G2', N'', N'@BOOK{Adams1978,  author = {Adams},  publisher = {Bookclub},  title = {H2G2},  year = {1978},  abstract = {The+answer+to+life,+the+universe+and+everything+is+42},  volume = {1}}', N'Adams. <i>H2G2</i>. 1. Bookclub (1978).');
